    ...
    Frost.prototype = {
      ...
      c$: function (selector) {
          ...
          if (typeof selector === 'undefined') {
           ...
           if ( is_id ) { 
	              _ret = _ret[0];
                for (attrname in Frost.prototype) { _ret[attrname] = Frost.prototype[attrname]; }
                _ret._used_id = is_id; is_id = false;
                return _ret;
           } else {
                _ret.used_id = false;
                return _ret; 
      ...
      delay: function (func, time) { time *= 1000;
      ...
      addSuffix: function (int) {
        ...
        if (end == 1) {var suffix = 'st';} 
        else if (end == 2) {var suffix = 'nd';}
        else if (end == 3) {var suffix = 'rd';}
        else {var suffix = 'th';} if (int == '11') suffix = 'th';
        return suffix;
      },
      keypress: function (/*  key,  */action) {
      ...
      attr: function (attr, val) {
        el = this.forEach(function(el) {return el;});
      ...
      css: (function (val) {
        dta = this.forEach(function(el) {return el;});
